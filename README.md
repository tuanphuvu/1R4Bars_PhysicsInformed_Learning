# Physics-Informed Learning vs MLP — Inverse Dynamics of a Rotating Four-Bar Linkage Robot
...
Dataset is used to train MLP model and Physics Informed model (to find physical parameters)

Finally compare the precision of these control models through tracking a new trajectory
